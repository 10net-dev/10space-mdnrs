...
export default async function DashboardPage() {
  ...
  const cardRole = [
    { title: 'Role', icon:FolderLock, href:"/admin/settings/master/role"},
    { title: 'Permission', icon:UserCheck, href:"/admin/settings/master/permission"}
  ];

  const cardData = [
    { title: 'Project', stats:42, icon:Building2, href:"/admin/master/project"},
    { title: 'Customer', stats:3, icon:FolderKanban, href:"/admin/master/customer"},
    { title: 'Vendor', stats:7, icon:FolderKanban, href:"/admin/master/vendor" }
  ];
