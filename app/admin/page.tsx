...
export default async function DashboardPage() {
  ...
  const cardData = [
    { title: 'Room', stats:42, icon:Building2, href:"/admin/room"},
    { title: 'Customer', stats:3, icon:FolderKanban, href:"/admin/customer"},
    { title: 'Vendor', stats:7, icon:FolderKanban, href:"/admin/vendor" },
    { title: 'Sales', stats:7, icon:Building2, href:"/admin/sales" },
    { title: 'Leads',  stats:71, icon:FolderKanban, href:"/admin/leads" },
    { title: 'Procurement',  stats:8, icon:FolderKanban, href:"/admin/procurement" },
